...
(library
  (lalr)
  (export lalr-parser make-lexical-token make-source-location)
  (import (chezscheme))
  ...
  (cond-expand
    ...
    (chezscheme
      ...
      (define-syntax BITS-PER-WORD
        (syntax-rules ()
          ((_) 29)))
      (define-syntax lalr-error
        (syntax-rules ()
          ((_ . args) `(error . ,args))))
      (define-syntax lalr-keyword?
        (syntax-rules ()
          ((_ arg) (symbol? arg))))
      (define-syntax logical-or
        (syntax-rules ()
          ((_ e1 e2) (logior e1 e2))))
      (define-syntax pprint
        (syntax-rules ()
          ((_ . args) `(pretty-print . ,args))))
      (define-syntax note-source-location
        (syntax-rules ()
          ((_ lvalue tok) lvalue))))
    (else
